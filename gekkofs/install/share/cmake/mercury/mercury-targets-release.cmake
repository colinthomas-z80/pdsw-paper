...
set_target_properties(mercury_util PROPERTIES
  IMPORTED_LOCATION_RELEASE "/afs/crc.nd.edu/user/c/cthoma26/gekkofs_deps/install/lib/libmercury_util.so.2.1.0"
  IMPORTED_SONAME_RELEASE "libmercury_util.so.2"
  )

list(APPEND _IMPORT_CHECK_TARGETS mercury_util )
list(APPEND _IMPORT_CHECK_FILES_FOR_mercury_util "/afs/crc.nd.edu/user/c/cthoma26/gekkofs_deps/install/lib/libmercury_util.so.2.1.0" )
...
set_target_properties(na PROPERTIES
  IMPORTED_LOCATION_RELEASE "/afs/crc.nd.edu/user/c/cthoma26/gekkofs_deps/install/lib/libna.so.2.1.0"
  IMPORTED_SONAME_RELEASE "libna.so.2"
  )

list(APPEND _IMPORT_CHECK_TARGETS na )
list(APPEND _IMPORT_CHECK_FILES_FOR_na "/afs/crc.nd.edu/user/c/cthoma26/gekkofs_deps/install/lib/libna.so.2.1.0" )
...
set_target_properties(mercury PROPERTIES
  IMPORTED_LOCATION_RELEASE "/afs/crc.nd.edu/user/c/cthoma26/gekkofs_deps/install/lib/libmercury.so.2.1.0"
  IMPORTED_SONAME_RELEASE "libmercury.so.2"
  )

list(APPEND _IMPORT_CHECK_TARGETS mercury )
list(APPEND _IMPORT_CHECK_FILES_FOR_mercury "/afs/crc.nd.edu/user/c/cthoma26/gekkofs_deps/install/lib/libmercury.so.2.1.0" )
...
set_target_properties(mercury_hl PROPERTIES
  IMPORTED_LOCATION_RELEASE "/afs/crc.nd.edu/user/c/cthoma26/gekkofs_deps/install/lib/libmercury_hl.so.2.1.0"
  IMPORTED_SONAME_RELEASE "libmercury_hl.so.2"
  )

list(APPEND _IMPORT_CHECK_TARGETS mercury_hl )
list(APPEND _IMPORT_CHECK_FILES_FOR_mercury_hl "/afs/crc.nd.edu/user/c/cthoma26/gekkofs_deps/install/lib/libmercury_hl.so.2.1.0" )
